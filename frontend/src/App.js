...
import { Card, Button, Select, Label, Alert, Spinner, Tabs, ThemeProvider } from 'flowbite-react';
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-center">
                    <label 
                      ...
                      className="w-48 h-48 flex flex-col items-center justify-center bg-gray-300 hover:bg-gray-400 rounded-2xl cursor-pointer transition-all shadow-lg hover:shadow-2xl"
                    >
                      <svg className="w-12 h-12 text-gray-600 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                      </svg>
                      <span className="text-lg font-bold text-gray-700">Click to Upload</span>
                      <span className="text-sm text-gray-600 mt-2">Images only</span>
                    </label>
                    <input
                      id="floorplan-file"
                      type="file"
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    >
                      ...
                      <span className="text-lg font-bold text-gray-700">Click to Upload</span>
                      <span className="text-sm text-gray-600 mt-2">PDF files only</span>
                    </label>
                    <input
                      id="gantt-file"
                      type="file"
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    >
                      ...
                      <span className="text-lg font-bold text-gray-700">Click to Upload</span>
                      <span className="text-sm text-gray-600 mt-2">PDF or Images</span>
                    </label>
                    <input
                      id="boq-file"
                      type="file"
