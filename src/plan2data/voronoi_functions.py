...
if __name__ == "__main__":
    ...
    # Alter Pfad (funktioniert nicht):
    # pdf_path = "src/validation/Floorplan/neighboring rooms/Simple Floorplan/Simple Floorplan/01_Simple.pdf"
    
    
    # ODER absoluter Pfad:
    pdf_path = "/Users/beckybuter/Documents/GitHub/Construction-Document-Parser-for-LLM-based-AI-assistants/src/validation/Floorplan/neighboring rooms/Simple Floorplan/Simple Floorplan/01_Simple.pdf"
